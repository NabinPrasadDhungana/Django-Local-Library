...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        # Create two users
        test_user1 = CustomUser.objects.create_user(username='testuser1', password='1X<ISRUkw+tuK')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        self.assertRedirects(response, reverse('books-on-loan'))
...
class AuthorCreateViewTest(TestCase):
    ...
    def setUp(self):
        ...
        # Assign permission to add an author
        content_type = Permission.objects.get(codename='add_author').content_type
